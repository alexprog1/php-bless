  ...
  <div class="row">
    ...
    <div class="col-md-9 col-lg-10 ml-md-auto px-0">
      ...
      <main class="container-fluid">
        <section class="row">
          <div class="container">
            <h1 class="mb-2 text-primary">Produtos</h1>
            <p class="lead text-muted">
              <a href="cadastrar_produtos.php" class="btn btn-">
                <button class="btn btn-info">Cadastrar produtos</button>
              </a>
            </p>
            
            <p class="lead text-muted">Todos os produtos cadastrados.</p>
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <?php 
                    include("conexao.php");
                    $result = mysqli_query($conn, "SELECT id, descricao, und, quantidade, marca, situacao FROM `produtos` ORDER BY id")or die(error());
                    if (!$result) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <td>%s</td> <td>%s</td> <td>%s</td></tr>\n", $row["id"], $row["descricao"], $row["und"], $row["quantidade"], $row["marca"], $row["situacao"]);
                  }?>
                </tr>
              </tbody>
            </table>       
